...
colnames(predictions_dropped_all) <- c("predicted", "dropped")
...
colnames(predictions_score_all) <- c("predicted", "score")
predictions_score_all <- predictions_score_all %>% 
  mutate(error = predicted - score)

ggplot(predictions_score_all)+
  geom_point(aes(x = score, y = predicted))
...
ggplot(predictions_score_genre)+
  geom_point(aes(x = score, y = predicted))
