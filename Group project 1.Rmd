...
ggplot(predictions_dropped_all)+
  geom_point(aes(x = dropped, y = predicted))

# Model prediction performance
data.frame(
  RMSE = RMSE(predicted, testing$dropped),
  Rsquare = R2(predicted, testing$dropped)
)
```
...
ggplot(predictions_dropped_genre)+
  geom_point(aes(x = dropped, y = predicted))
